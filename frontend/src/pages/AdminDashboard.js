              ...
              <div className="bg-white border border-border/40 p-6 mb-6">
                ...
                <form onSubmit={handleCreateBanner} className="space-y-4">
                  ...
                  <div className="p-4 bg-amber-50 border border-amber-200 rounded-lg">
                    ...
                    <p className="text-xs text-amber-700 mb-3">Leave empty to show banner always. Set dates for seasonal promotions, festivals, or sales events.</p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 border border-input bg-white focus:outline-none focus:ring-1 focus:ring-secondary"
                          data-testid="banner-start-date"
                        />
                      </div>
                      <div>
